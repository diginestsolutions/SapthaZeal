...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="col-lg-10  col-md-12" id="main">
            ...
            border:none;"><span class="left"><i class="fa-solid fa-chevron-left"></i></span></button></i></a>View Order
                </h3>
                        ...
                        <div class="row col-lg-12">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class=" form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="{{$order->subscription->name}}" readonly>                                    
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class=" form-group">
                                    <label class="title-label">Duration<span style="color: red;">*</span></label>
                                    <input type="text" class="form-control form-control-lg" value="{{$order->duration}}" readonly>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class=" form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="Paid" readonly>
                                    @endif
                                    @if($order->payment_status == "pending")
                                    <input type="text" class="form-control form-control-lg" value="Pending" readonly>
                                    @endif
                                    @if($order->payment_status == "cancelled")
                                    <input type="text" class="form-control form-control-lg" value="Cancelled" readonly>
                                    @endif
                                </div>
                            </div>
