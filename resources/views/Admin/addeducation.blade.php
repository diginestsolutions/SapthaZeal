    ...
    <div class="wrapper d-flex ">
        ...
        <div class="col-lg-10  col-md-12" id="main">
            ...
            <nav class="navbar navbar-light col-md-12 ">
                ...
                <h3 class=" mt-3   heading"> <a class="btn mr-2 " href="{{ route('view.candidate') }}"><span
                            ...
                            <div class="row col-lg-12">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <div class=" form-group select-sup">
                                        ...
                                        <label class="title-label">Board</label>


                                        <select class="form-control select form-control-lg" name="board" required>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <div class=" form-group">
                                        <label class="title-label">School Medium</label>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <div class=" form-group">
                                        <label class="title-label">Pass Out</label>

                                        <input type="text" class="form-control form-control-lg" name="passout" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-12">
                                    ...
                                    <div class=" form-group">
                                        <label class="title-label"></i>Marks Obtained(%)</label>

                                        <input type="text" class="form-control form-control-lg" name="marks" required>
                                    </div>
                                </div>
                    ...
                    <div class="row col-lg-12">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg gradient-button gradient-button-1"
            ...
            <div id="showGrad" class="myDiv">
                <div class="row col-lg-12">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class=" form-group">
                            <label class="title-label">Specialization</label>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class=" form-group select-sup">
                            ...
                            <label class="title-label">University/Institute</label>


                            <select class="form-control select form-control-lg" name="university" required>
