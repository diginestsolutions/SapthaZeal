...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="col-lg-10  col-md-12" id="main">
            ...
            <nav class="navbar navbar-light col-md-12 ">
                ...
                <h3 class=" mt-3  heading"> <a class="btn " href="{{ route('view.industry') }}"><span class="icon2"><button
            ...
            <div class=" col-md-12 ">
                <div class=" widget-content ">
                    <form class="" action="{{ route('add.industry') }}" method="POST" enctype="multipart/form-data">
                        @csrf
