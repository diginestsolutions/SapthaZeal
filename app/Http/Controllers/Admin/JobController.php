...
class JobController extends Controller
{
    ...
    {
        $job = Job::with('user')->orderBy('_id', 'ASC')->get();
    ...
    public function store(Request $request)
    {
        try{
            $job = new Job;
            $job->nextid();
            $job->jobprovider = Auth::guard('admin')->user()->id;
    ...
    public function candidatechatbox($id)
    {
        ...
        $message = Message::where('candidate_id',$candidate_id)->where('admin_id',Auth::guard('admin')->user()->id)->get();
